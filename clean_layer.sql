...
CREATE OR REPLACE STREAM SANDBOX.CLEAN_SCH.RESTAURANT_LOCATION_STM ON TABLE SANDBOX.CLEAN_SCH.RESTAURANT_LOCATION SHOW_INITIAL_ROWS = TRUE;
...
CREATE OR REPLACE STREAM SANDBOX.CLEAN_SCH.MENU_STM 
  ON TABLE SANDBOX.CLEAN_SCH.MENU 
